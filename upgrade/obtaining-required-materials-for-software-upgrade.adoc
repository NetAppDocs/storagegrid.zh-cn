...
StorageGRID 文档
 a| 
* https://library.netapp.com/ecm/ecm_download_file/ECMLP3373065["发行说明"^]。您必须使用您的 NetApp 帐户登录或创建帐户才能访问发行说明。在开始升级之前，请务必仔细阅读这些内容。
* https://kb.netapp.com/hybrid/StorageGRID/Maintenance/StorageGRID_12.1_software_upgrade_resolution_guide["StorageGRID 软件升级解决方案指南"^] 对于要升级到的主要版本（需要登录）
