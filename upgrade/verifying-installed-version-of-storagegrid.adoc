...
.关于此任务
在升级到 StorageGRID 12.1 之前，您的网格必须已安装 StorageGRID 12.0 或更高版本。如果您当前使用的是较早版本的 StorageGRID，则必须安装所有以前的升级文件及其最新修补程序（强烈建议），直到网格的当前版本至少为 StorageGRID 12.0.0。
...
以下示例显示了从 StorageGRID 版本 11.9 升级到版本 12.0 以准备 StorageGRID 12.1 升级的步骤。
