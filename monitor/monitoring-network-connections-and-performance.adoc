...
+
image:nodes_page_network_traffic_graph.png["节点页面网络流量图"]

+
.. 如果选择了网格节点，请向下滚动以查看页面的 * 网络接口 * 部分。
+
image:nodes_page_network_interfaces.png["节点页面网络接口"]
...
+
image:nodes_page_network_communication.png["节点页面网络通信"]
...
+
image:traffic_classification_policies_main_screen_w_examples.png["图形的流量策略示例"]
...
+
image:nodes_page_hardware_tab_graphs.png["节点页面硬件选项卡"]
