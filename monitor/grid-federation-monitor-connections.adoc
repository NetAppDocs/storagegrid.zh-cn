...
+
image:grid-federation-connections-tab.png["网格联合连接选项卡"]
...
+
image:grid-federation-permitted-tenants-tab.png["网格联盟允许的租户选项卡"]
...
+
image:grid-federation-permitted-tenants-tab-for-connection.png["grid联合允许的租户选项卡(用于连接)"]
...
+
image:grid-federation-certificates-tab.png["grid联合证书选项卡"]
