...
+
image:grid_federation_connections_tab.png["网格联合连接选项卡"]
...
+
image:grid_federation_permitted_tenants_tab.png["网格联盟允许的租户选项卡"]
...
+
image:grid_federation_permitted_tenants_tab_for_connection.png["grid联合允许的租户选项卡(用于连接)"]
...
+
image:grid_federation_certificates_tab.png["grid联合证书选项卡"]
