...
+
image:metrics_page.png["指标页面"]

. 要查询 StorageGRID 指标的当前值并查看随时间变化的值图形，请选择 Prometheus 部分中的链接。
+
...
. 要访问包含 StorageGRID 指标随时间变化图表的预构建仪表板，请选择 Grafana 部分中的链接。
+
此时将显示选定链接的 Grafana 界面。

+
image:metrics_page_grafana.png["指标页面 Grafana"]
