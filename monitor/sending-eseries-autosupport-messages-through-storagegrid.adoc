...
* 您有 link:../admin/admin-group-permissions.html["存储设备管理员或root访问权限"]。
...
+
image:autosupport_santricity_home_page.png["AutoSupport SANtricity 主页"]
...
+
image:autosupport_santricity_operations.png["AutoSupport SANtricity AutoSupport 操作"]
...
+
image:autosupport_configure_delivery_santricity.png["AutoSupport 配置 AutoSupport 交付方法 SANtricity"]
