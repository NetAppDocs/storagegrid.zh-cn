...
NOTE: 要使用 SANtricity System Manager 为 E 系列 AutoSupport 配置代理，请参阅 link:sending-eseries-autosupport-messages-through-storagegrid.html["通过StorageGRID发送E系列AutoSupport软件包"]。
...
image:nodes_page_santricity_tab.png["节点页面 SANtricity 选项卡"]
