...
---
= 在 StorageGRID 中使用 ILM 策略和 ILM 规则
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. 选择要查看其详细信息的规则的名称。示例：
+
image:ilm_rule_details_page.png["ILM规则详细信息页面"]
...
. 监控ILM选项卡上的指标。
+
您可以选择问号 image:icon_nms_question.png["问号图标"] 以查看 ILM 选项卡上各项目的说明。

+
image:ilm_metrics_on_dashboard.png["Grid Manager信息板上的ILM指标"]
