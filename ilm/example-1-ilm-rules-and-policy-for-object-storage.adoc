...
---
= StorageGRID 中基本对象保护和保留的 ILM 规则和策略
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
image:ilm_rule_two_copies_two_data_centers.png["ILM规则1示例1：将对象数据复制到两个站点"]
...
|===
image:ilm_rule_ec_for_s3_bucket_finance_records.png["ILM规则2示例1：具有存储分段匹配的纠删编码配置文件"]
...
+
image:policy_1_configured_policy.png["ILM 策略示例 1"]
