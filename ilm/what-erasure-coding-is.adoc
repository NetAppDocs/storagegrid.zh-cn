...
image:ec_three_sites_4_plus_2.png["对三个站点 4 加 2 进行纠删编码"]
...
image:ec_recoverable_4_plus_2.png["纠删编码可恢复 4 加 2"]

如果丢失两个以上的存储节点，则无法检索此对象。

image:ec_unrecoverable_4_plus_2.png["纠删编码不可恢复 4 加 2"]
