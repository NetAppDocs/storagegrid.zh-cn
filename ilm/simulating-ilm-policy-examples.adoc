...
image:simulate_policy_screen.png["模拟策略结果"]
...
+
image:simulate_reorder_rules_pngs_result.png["示例2：模拟ILM策略时重新排列规则"]
...
+
image:simulate_reorder_rules_correct_result.png["示例2：模拟ILM策略时重新排列规则"]
...
image:simulate_results_for_object_wrong_metadata.png["示例3：在模拟ILM策略时更正规则"]
...
+
image:simulate_results_for_object_corrected_metadata.png["示例3：在模拟ILM策略时更正规则"]
