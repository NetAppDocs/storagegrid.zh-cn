...
---
= 用于在 StorageGRID 中保护映像文件的 ILM 规则和策略
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
image:policy_3_rule_1_ec_images_adv_filtering.png["ILM 规则 1 ，例如 3 ：对大于 1 MB 的映像文件使用 EC"]
...
image:policy_3_configured_policy.png["示例 3 中的 ILM 策略：更好地保护映像文件"]
