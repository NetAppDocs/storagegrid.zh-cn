...
summary: '选择"开始恢复"以在主管理节点恢复期间配置主管理节点。' 
---
= 选择"开始恢复"以配置主管理节点
:allow-uri-read: 
:icons: font
...
[role="lead"]
替换主管理节点后，必须在 Grid Manager 中选择 Start Recovery，将新节点配置为故障节点的替换节点。
...
NOTE: 在恢复过程运行时，您可以选择 *Reset* 以开始新的恢复。将显示一个对话框，指示如果重置过程，节点将保持不确定状态。
