...
* 所有网格节点均处于正常（绿色）运行状况 image:icon_alert_green_checkmark.png["绿色复选标记图标"]。如果您在 *Health* 列中看到以下图标之一，则必须尝试解决此问题：
+
[cols="1a,1a,3a"]
|===
| 图标 | 颜色 | 严重性 
 ...
 a| 
image:icon_alarm_yellow_notice.gif["黄色方形图标"]
 a| 
黄色
 a| 
通知
 ...
 a| 
image:icon_alert_yellow_minor.png["浅橙色钻石图标"]
 a| 
浅橙色
 a| 
次要
 ...
 a| 
image:icon_alert_orange_major.png["深橙色钻石图标"]
 a| 
深橙色
 a| 
主要
 ...
 a| 
image:icon_alert_red_critical.png["红色 x 图标"]
 a| 
红色
 a| 
关键
