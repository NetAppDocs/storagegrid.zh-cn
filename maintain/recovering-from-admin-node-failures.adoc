...
.选项
* link:recovering-from-primary-admin-node-failures.html["使用相同的主管理节点恢复主管理节点"]
* link:recovering-from-primary-admin-node-failures-using-npan.html["使用非主管理节点从主管理节点故障中恢复"]
