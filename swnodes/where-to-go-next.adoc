...
* （仅限 VMware）配置 VMware vSphere Hypervisor 以实现自动重启。
+
...
* link:../maintain/changing-ip-addresses-and-mtu-values-for-all-nodes-in-grid.html["更新网格节点IP地址"]如果自您计划部署并生成恢复包以来它们已经发生了变化。
