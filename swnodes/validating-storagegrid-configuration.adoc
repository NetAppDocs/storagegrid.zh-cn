...
image:rhel_node_configuration_file_output.gif["此图通过周围文字进行了说明。"]
...
image:rhel_node_configuration_file_output_with_errors.gif["此图通过周围文字进行了说明。"]
