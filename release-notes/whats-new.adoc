...
summary: StorageGRID 12.0 扩展了对象存储容量，改进了 AI/ML 工作负载支持，加强了网格联合，简化了系统管理，并增强了整个平台的安全性。 
---
...
[role="lead"]
StorageGRID 12.0 扩展了对象存储容量，改进了 AI/ML 工作负载支持，加强了网格联合，简化了系统管理，并增强了整个平台的安全性。

有关最新 StorageGRID 12.0 版本中的修复问题和已知问题的详细信息，请参见 https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["StorageGRID 12.0 发行说明"^]。您必须使用您的 NetApp 帐户登录或创建一个帐户才能访问发行说明。
