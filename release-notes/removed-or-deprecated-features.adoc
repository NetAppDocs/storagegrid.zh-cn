...
sidebar: sidebar 
keywords:  
summary: 了解 StorageGRID 12.0 中已删除或弃用的特性和功能。在升级之前，请检查任何已删除或已弃用的功能是否会影响客户端应用程序或网格配置。 
---
...
[role="lead"]
了解 StorageGRID 12.0 中已删除或弃用的特性和功能。在升级之前，请检查任何已删除或已弃用的功能是否会影响客户端应用程序或网格配置。
