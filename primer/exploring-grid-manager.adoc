...
image:grid_manager_dashboard_and_menu.png["网格管理器中的信息板"]

有关每张卡上显示的信息的说明，请选择该卡的帮助图标 image:icon_nms_question.png["问号图标"]。
...
帮助菜单 image:icon_help_menu_bar.png["菜单栏上的帮助图标"] 提供对以下内容的访问：
...
* 使用 link:../admin/grid-federation-overview.html["网格联盟"] 在两个 StorageGRID 系统之间同步租户帐户信息和复制对象数据
...
* link:../monitor/configure-email-server.html["配置电子邮件服务器"]
...
* link:../admin/about-multi-admin-verify.html["配置多管理员验证"]
...
* link:../monitor/configure-autosupport-grid-manager.html["配置 AutoSupport"]
