...
有关详细信息，请参见 link:../ilm/how-objects-and-delete-markers-are-deleted.html["如何删除对象和删除标记"]。
...
image:delete_data_flow.png["客户端删除数据流"]
...
image:automatic_deletion_data_flow.png["自动删除数据流"]
