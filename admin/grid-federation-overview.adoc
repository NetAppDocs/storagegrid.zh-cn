...
image:grid-federation-workflow.png["网格联合连接工作流"]
...
+
有关版本要求的详细信息，请参见 https://library.netapp.com/ecm/ecm_download_file/ECMLP3351267["发行说明"^]。您必须使用您的 NetApp 帐户登录或创建一个帐户才能访问发行说明。
...
image:grid-federation-certificates.png["网格联合证书"]
