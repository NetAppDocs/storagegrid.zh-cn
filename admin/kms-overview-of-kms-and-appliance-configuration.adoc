...
summary: '在使用密钥管理服务器 (KMS) 保护设备节点上的 StorageGRID 数据之前，您必须设置一个或多个 KMS 服务器并为设备节点启用节点加密。完成这两项配置任务后，密钥管理过程将自动进行。' 
---
...
image:kms_configuration_overview.png["Kms配置工作流、将在以下文本中进行介绍"]
