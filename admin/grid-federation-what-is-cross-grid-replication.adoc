...
image:grid-federation-cross-grid-replication-one-direction.png["显示一个方向的网格联合连接的图像"]
...
image:grid-federation-cross-grid-replication.png["显示单向复制与双向复制的图像"]
...
image:grid-federation-cross-grid-replication-delete.png["显示在两个网格上复制客户端删除的图像"]
