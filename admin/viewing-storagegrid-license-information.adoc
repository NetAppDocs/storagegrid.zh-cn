...
image:dashboard_health_panel_license_status.png["信息板运行状况卡许可证状态"]
...
** 支持结束日期
+
此日期是从当前许可证文件读取的，如果您在获取许可证文件后延长或续订支持服务合同，则此日期可能已过期。要更新此值，请参阅link:updating-storagegrid-license-information.html["更新 StorageGRID 许可证信息"]。您还可以使用 Digital Advisor 查看实际合同结束日期。
