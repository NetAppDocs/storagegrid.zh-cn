...
[role="lead"]
如果你有link:../admin/how-sso-works.html["已配置并启用单点登录（ SSO ）"]并且您使用 Active Directory 作为 SSO 提供程序，则必须发出一系列 API 请求以获取对网格管理 API 或租户管理 API 有效的身份验证令牌。
...
+
image:sso_auth_python_script_adfs.png["适用于 AD FS 的 SSO 身份验证脚本"]
