...
+
--
如果您计划使用 S3 虚拟托管风格的请求，则应该使用link:../admin/configuring-s3-api-endpoint-domain-names.html["已配置S3端点域名"]。建议使用虚拟托管风格的请求。
...
--
配置任何网格联合连接:: 如果要允许 S3 租户使用网格联合连接同步帐户数据并将存储区对象复制到另一个网格，请在启动向导之前确认以下内容：
+
--
