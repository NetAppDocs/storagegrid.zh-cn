...
. 如果添加了管理节点：
+
.. 如果您的 StorageGRID 系统启用了单点登录 (SSO)，请为新的管理节点创建一个依赖方信任。在创建此依赖方信任之前，无法登录到该节点。请参阅使用 link:../admin/learn-about-setting-up-sso-oidc.html["OIDC"] 或 link:../admin/learn-about-setting-up-sso-saml.html["SAML"] 设置 SSO。
