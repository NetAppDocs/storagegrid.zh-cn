...
---
= 在 StorageGRID 中为 FabricPool 创建租户帐户
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. （可选）选择 *Use grid federation connection* 以允许租户使用 link:../admin/grid-federation-overview.html["网格联合连接"] 进行帐户同步和跨网格复制。然后，选择要使用的网格联合连接。
