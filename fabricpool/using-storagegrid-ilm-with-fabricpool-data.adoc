...
---
= 为 FabricPool 数据配置 StorageGRID ILM
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* 如果从 11.7 之前的 StorageGRID 版本升级到 StorageGRID 12.1，则已配置要使用的存储池。一般来说，您应该为要用于存储数据的每个 StorageGRID 站点创建一个存储池。（从版本 11.7 开始，系统会自动为每个站点创建存储池。）
+
