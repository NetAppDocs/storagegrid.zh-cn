...
---
= 使用 FabricPool 为 StorageGRID 配置 DNS 服务器条目
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
如果您已定义link:../admin/configuring-s3-api-endpoint-domain-names.html["S3端点域名"]并且将使用虚拟托管样式的请求，请为所有必需的 S3 端点域名添加 DNS 条目，包括任何通配符名称。
