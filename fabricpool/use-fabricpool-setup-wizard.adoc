...
---
= 了解 StorageGRID FabricPool 设置向导
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* 如果您计划使用 S3 虚拟托管式请求，则需要 link:../admin/configuring-s3-api-endpoint-domain-names.html["已配置S3端点域名"]。ONTAP 默认使用路径样式的 URL，但建议使用虚拟托管样式的请求。
