...
+
image:grid_federation_post_current_user_replicate.png["发布端点以复制自己的访问密钥"]
...
+
image:grid_federation_clone_access_key.png["租户管理器API、输入用于克隆访问密钥的值"]
...
+
image:grid_federation_post_other_user.png["发布用于复制其他用户访问密钥的端点"]
