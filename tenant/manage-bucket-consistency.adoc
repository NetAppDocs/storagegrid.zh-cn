...
* link:../s3/use-access-policies.html["存储分段策略"]
...
* link:configuring-cross-origin-resource-sharing-for-buckets-and-objects.html["为存储桶和对象配置StorageGRID CORS"]
