...
. 确定节点的硬件是否脱机。
. 如果为您的 StorageGRID 系统启用了单点登录 (SSO)，请参阅使用 link:../admin/learn-about-setting-up-sso-oidc.html["OIDC"] 或 link:../admin/learn-about-setting-up-sso-saml.html["SAML"] 设置 SSO。
+
